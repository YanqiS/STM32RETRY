...
//				//TA531TimCallback
			...
			// ========== HSD1 控制（左上开关）==========
			if (TA531SysEnv.TA531_env_Relay1 == 0)  // Relay1 = 1 → 关闭
					{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD1_GPIO_Port,
						DOOR_RELAY_HSD1_Pin, 0);
			} else  // Relay1 = 0 或 2 → 常开
			{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD1_GPIO_Port,
			...
			// ========== HSD2 控制（右上开关）==========
			if (TA531SysEnv.TA531_env_Relay2 == 0)  // Relay2 = 1 → 关闭
					{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD2_GPIO_Port,
						DOOR_RELAY_HSD2_Pin, 0);
			} else  // Relay2 = 0 或 2 → 常开
			{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD2_GPIO_Port,
			...
			// ========== HSD3 控制（左下开关）==========
			if (TA531SysEnv.TA531_env_Relay3 == 0)  // Relay3 = 1 → 关闭
					{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD3_GPIO_Port,
						DOOR_RELAY_HSD3_Pin, 0);
			} else  // Relay3 = 0 或 2 → 常开
			{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD3_GPIO_Port,
			...
			// ========== HSD4 控制（右下开关）==========
			if (TA531SysEnv.TA531_env_Relay4 == 0)  // Relay4 = 1 → 关闭
					{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD4_GPIO_Port,
						DOOR_RELAY_HSD4_Pin, 0);
			} else  // Relay4 = 0 或 2 → 常开
			{
				HAL_GPIO_WritePin(DOOR_RELAY_HSD4_GPIO_Port,
			...
			// ========================================
			// 保留Y_RELAY_5和Y_RELAY_6（如果需要）
			// ========================================

			if (TA531SysEnv.TA531_env_Relay5 == 1) {
			...
			if (TA531SysEnv.TA531_env_Relay6 == 1) {
...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOC,
			DOOR_RELAY_HSD1_Pin | DOOR_RELAY_HSD2_Pin | Y_RELAY_1_Pin
					| Y_RELAY_2_Pin, GPIO_PIN_RESET);
	...
	HAL_GPIO_WritePin(GPIOD,
			LIN3_EN_Pin | Eshft_RELAY_Pin | LIN1_EN_Pin | LIN2_EN_Pin,
			GPIO_PIN_RESET);
